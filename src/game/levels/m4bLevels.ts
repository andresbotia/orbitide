...
export const M4B_LEVELS: LevelDefinition[] = [
  ...
  makeLevel({ id: 31, title: 'Old Hourglass', themeId: 'curio-cabinet', difficulty: 'medium',
    ...
    queues: [['yellow','white'],['orange','cyan'],['red','gold']] }),
  ...
  makeLevel({ id: 33, title: 'Music Box', themeId: 'curio-cabinet', difficulty: 'medium',
    ...
    queues: [['gold','yellow','white'],['red','orange'],['cyan','magenta','purple']] }),
  makeLevel({ id: 34, title: 'True Compass', themeId: 'curio-cabinet', difficulty: 'medium',
    ...
    queues: [['blue','red','green'],['yellow'],['gold','cyan','white']] }),
  ...
  makeLevel({ id: 39, title: 'Velvet Crown', themeId: 'curio-cabinet', difficulty: 'hard',
    ...
    queues: [['pink','purple','white'],['red','gold'],['magenta','yellow']] }),
  makeLevel({ id: 40, title: 'The Curio Chest', themeId: 'curio-cabinet', difficulty: 'hard',
    ...
    queues: [['yellow','blue','indigo'],['green','white','cyan'],['red','gold']], modifiers: F(['4,2','3,4','5,4','4,5']) }),
  ...
  makeLevel({ id: 51, title: 'Frostglass Bell', themeId: 'frostglass-forge', difficulty: 'medium',
    ...
    queues: [['yellow','gold','red'],['teal','green'],['white','cyan']], modifiers: MIX(['4,0'],['3,5']) }),
  makeLevel({ id: 52, title: 'Arcane Shears', themeId: 'frostglass-forge', difficulty: 'medium',
    ...
    queues: [['white','green'],['yellow','blue'],['red']], modifiers: MIX(['2,2','3,3'],['6,2','5,3']) }),
  ...
  makeLevel({ id: 55, title: 'Gilded Gear', themeId: 'frostglass-forge', difficulty: 'medium',
    ...
    queues: [['blue','white'],['red','green'],['gold','yellow']], modifiers: MIX(['4,4','2,3'],['3,5','4,6']) }),
  makeLevel({ id: 56, title: 'Crystal Hammer', themeId: 'frostglass-forge', difficulty: 'medium',
    art: ['.CCCCCCC.','CBBBBBBBC','CBNNWNNBC','CBNWYW NBC'.replace(' ',''),'CBNNWNNBC','CBBBBBBBC','.CCCCCCC.','...RRR...','...AAA...'],
    queues: [['gold','white','yellow'],['indigo','red'],['cyan','blue']], modifiers: MIX(['4,2','4,3','4,4'],['1,5','4,5','7,5']) }),
  makeLevel({ id: 57, title: 'Frostbound Violin', themeId: 'frostglass-forge', difficulty: 'medium',
    art: ['..AAAAA..','.AARRRAA.','..RRRRR..','..RRRRR..','..PRRRP..','.PPPPPPP.','..PBBBP..','...NNN...','..CC.CC..'],
    queues: [['red','cyan'],['purple','blue'],['gold','indigo']], modifiers: MIX(['4,2','4,6'],['3,5','4,5','3,7']) }),
  makeLevel({ id: 58, title: 'The Rune Engine', themeId: 'frostglass-forge', difficulty: 'medium',
    art: ['.NNNNNNN.','N.BBBBB.N','NBCC.CCBN','NBCWWWCBN','NBCWYWCBN','NBCW.WCBN','NBCC.CCBN','N.BBBBB.N','.NNRRRNN.'],
    queues: [['yellow','white','red'],['cyan','blue'],['indigo']], modifiers: MIX(['4,3','3,4'],['4,4','3,6','5,6']) }),
  makeLevel({ id: 59, title: 'Prismatic Reliquary', themeId: 'frostglass-forge', difficulty: 'hard',
    ...
    queues: [['cyan','white','yellow'],['blue','purple'],['gold','red']], modifiers: MIX(['4,2','3,4'],['5,3','4,4']) }),
  makeLevel({ id: 60, title: 'The Frostglass Crown', themeId: 'frostglass-forge', difficulty: 'hard',
    ...
    queues: [['red','purple'],['gold','green'],['blue','cyan']], modifiers: MIX(['4,3','3,4','4,5'],['2,2','6,2','4,4']) }),
];
