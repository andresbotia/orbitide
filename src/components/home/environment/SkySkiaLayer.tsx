...
interface SkySkiaLayerProps {
  width: number;
  height: number;
}

/**
 * SKY (Skia) — flat horizontal colour bands, a slatted sun, and a star field.
 *
 ...
 *
 * ── SKIA FALLBACK ─────────────────────────────────────────────────────────
 * Procedural implementation, kept as the fallback for `SkyLayer`, which now
 * renders assets/home-sky.png. To switch back, follow the swap point in
 * SkyLayer.tsx. HomeEnvironment owns the transforms, so the animation
 * code is untouched either way.
 * ──────────────────────────────────────────────────────────────────────────
 */
export const SkySkiaLayer = memo(function SkySkiaLayer({ width, height }: SkySkiaLayerProps) {
