...
export const typography = {
   ...
   */
  display: { fontSize: 28, letterSpacing: 0.4, fontWeight: '800' as const },
  title: { fontSize: 24, letterSpacing: 0.8, fontWeight: '800' as const },
  /**
  ...
  label: { fontSize: 13, letterSpacing: 1.6, fontWeight: '700' as const },
